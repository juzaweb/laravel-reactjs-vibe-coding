...
Route::get('payment/{module}/return/{paymentHistoryId}', [PaymentController::class, 'return'])->name('api.payment.return');
Route::get('payment/{module}/cancel/{paymentHistoryId}', [PaymentController::class, 'cancel'])->name('api.payment.cancel');
Route::get('payment/{module}/embed/{paymentHistoryId}', [PaymentController::class, 'embed'])->name('api.payment.embed');
Route::get('payment/{module}/status/{paymentHistoryId}', [PaymentController::class, 'status'])->name('api.payment.status');
